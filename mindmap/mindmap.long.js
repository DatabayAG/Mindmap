...
(function( $ ){
	...
	var nodeMove = function(mindmap, e) {
	    ...
	    $(window).bind('mousemove.nodedragging touchmove.nodedragging', function(e) {
		e.preventDefault();
		var positionProvider;
		if (typeof e.originalEvent.touches != 'undefined') {
		    positionProvider = e.originalEvent.touches[0];
	    ...
	    $(window).bind('mouseup.nodedragging touchend.nodedragging', function(e) {
		mindmap.objactive = "";
		$(window).unbind('.nodedragging');
    ...
    var methods = {
        init : function( options ) {
            ...
            return $(this).each(function(){
				...
				var me = this;
				$(window).bind('mousemove.controllerdragging touchmove.controllerdragging', function(e) {
				    var positionProvider;
				    if (typeof e.originalEvent.touches != 'undefined') {
					positionProvider = e.originalEvent.touches[0];
				    }
				...
				$(window).bind('mouseup.controllerdragging touchend.controllerdragging', function(e) {
				    mindmap.objactive = "";
	
				    dragData.dragging = false;
				    $(window).unbind('.controllerdragging');
